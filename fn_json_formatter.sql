CREATE OR ALTER FUNCTION [jadoube].[fn_json_formatter](@json nvarchar(max))
...
Usage:
[jadoube].[fn_json_formatter]('{"game": ["Super", "Mario", "Odyssey"], "moons": 880, "bosses": {"Cascade": "Madame Broode", "Metro": "Mechawiggler", "Ruined": "Lord of Lightning"}}')
>>> {
		"game": [
			"Super",
			"Mario",
