CREATE OR ALTER PROCEDURE [dbo].[usp_structure_compliance] (
...
Usage:
>>> EXECUTE [dbo].[usp_structure_compliance] @job_name = 'FastStats_001_DataMart', @schema = NULL, @table = '##mastercontact', @print = 1
